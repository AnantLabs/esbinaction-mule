...
/**
 * This class was generated by Apache CXF (incubator) 2.0.5-incubator Sun Apr 13
 * 14:50:56 CEST 2008 Generated source version: 2.0.5-incubator
 * 
 */

@javax.jws.WebService(name = "CoCPortType", serviceName = "CoCService", portName = "CoCSoap", targetNamespace = "http://opensource.esb.org/CoC/", wsdlLocation = "file:/home/nl24167/java/book/workspace/workspace-mule/mule/ivy-test/exampleTarget/workspace/workspace-mule/mule/resources/chapter7/provide-wsdl-top-down/CoC.wsdl", endpointInterface = "org.esb.opensource.coc.CoCPortType")
public class CoCPortTypeImpl implements CoCPortType {

    private ChamberOfCommerceServiceImpl delegate;
    private static final Logger LOG = Logger.getLogger(CoCPortTypeImpl.class
            .getName());
    ...
    public Company getCompany(String companyName) {
        esb.chapter7.Company company = delegate.getCompany(companyName);
    ...
    public ListOfCompanies findCompanies(String city, String streetName) {
        List<esb.chapter7.Company> companies = delegate.findCompanies(city,
                streetName);
    ...
    private Company copyCompanyFromDomain(esb.chapter7.Company company) {
        ...
        if (company != null) {
            ...
            for (esb.chapter7.Director director : company.getBoardOfDirectors()) {
                result.getBoardOfDirectors().getDirector().add(
                        copyDirectoryFromDomain(director));
            }
        }
    ...
    private esb.chapter7.Director copyDirectorFromDomain(Director director) {
        ...
        result.setDateOfBirth(director.getDateOfBirth().toGregorianCalendar()
                .getTime());
        result.setFirstName(director.getFirstName());
        result.setLastName(director.getLastName());
